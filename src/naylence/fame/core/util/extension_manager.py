...
class ExtensionManager(Generic[T]):
    ...
    def get_extensions_by_type(cls, base_type: Type[Any]) -> Dict[str, Any]:
        ...
        Implement this based on your existing registry. If you already
        have this, keep your implementation and delete this stub.
        """
        # STUB: replace with your real lookup
        return cls._extensions.get(base_type, {})  # type: ignore[attr-defined]
